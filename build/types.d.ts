...
declare type UserRegistryElementDataset = {
    [K in keyof IUserRegistryElementDataset]: IUserRegistryElementDataset[K];
};
export declare type AttributesKey = keyof IAttributes;
export declare type ObservedAttribute = keyof typeof ObservedAttributes;
export declare type AddNewUserResponse = IResponseBase & (IAddNewUserSuccessResponse | IAddNewUserFailedResponse);
export declare type GetNewUserResponse = IResponseBase & (IGetUserSuccessResponse | IGetUserFailedResponse);
export declare type GetTemplate<P extends IGetTemplate> = P['selector'] extends Selector.style ? HTMLStyleElement : P['selector'] extends Selector.addNewUserButton ? HTMLButtonElement : P['selector'] extends Selector.confirmDialog | Selector.shadowUi | Selector.user | Selector.confirmDeleteDialog | Selector.confirmAddNewUserDialog ? HTMLDivElement : null;
export {};
